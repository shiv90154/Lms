...
export default function CreateTestPage() {
    ...
    const [formData, setFormData] = useState({
        ...
        instructions: ['Read all questions carefully', 'Each question carries equal marks', 'Negative marking is applicable'],
        category: '',
        examType: '',
        difficulty: 'mixed',
        isPaid: false,
    ...
    return (
        <div className="container mx-auto p-6 max-w-6xl">
            <div className="mb-6">
                ...
                <p className="text-gray-600 mt-1">Configure test settings, sections, and questions</p>
            </div>
